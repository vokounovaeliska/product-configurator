...
object UserMocks {
    ...
    fun getUser(
        ...
        quoteRequestEmailBodyIsHtml: Boolean = false,
        quoteRequestEmailLabels: Map<String, String>? = null,
        ...
        supplierNotificationEmailBodyIsHtml: Boolean = false,
        supplierNotificationEmailLabels: Map<String, String>? = null,
