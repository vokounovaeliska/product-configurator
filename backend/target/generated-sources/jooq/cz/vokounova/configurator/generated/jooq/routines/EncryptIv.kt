...
open class EncryptIv : AbstractRoutine<ByteArray>("encrypt_iv", Public.PUBLIC, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = EncryptIv.RETURN_VALUE
        addInParameter(EncryptIv._1)
        addInParameter(EncryptIv._2)
        addInParameter(EncryptIv._3)
        addInParameter(EncryptIv._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: ByteArray?): Unit = setValue(EncryptIv._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(EncryptIv._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: ByteArray?): Unit = setValue(EncryptIv._2, value)
    ...
    fun set__2(field: Field<ByteArray?>): Unit {
        setField(EncryptIv._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: ByteArray?): Unit = setValue(EncryptIv._3, value)
    ...
    fun set__3(field: Field<ByteArray?>): Unit {
        setField(EncryptIv._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: String?): Unit = setValue(EncryptIv._4, value)
