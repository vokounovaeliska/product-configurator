...
open class GtrgmDistance : AbstractRoutine<Double>("gtrgm_distance", Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
    ...
    init {
        returnParameter = GtrgmDistance.RETURN_VALUE
        addInParameter(GtrgmDistance._1)
        addInParameter(GtrgmDistance._2)
        addInParameter(GtrgmDistance._3)
        addInParameter(GtrgmDistance._4)
        addInParameter(GtrgmDistance._5)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(GtrgmDistance._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(GtrgmDistance._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(GtrgmDistance._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(GtrgmDistance._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Short?): Unit = setValue(GtrgmDistance._3, value)
    ...
    fun set__3(field: Field<Short?>): Unit {
        setField(GtrgmDistance._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Long?): Unit = setValue(GtrgmDistance._4, value)
    ...
    fun set__4(field: Field<Long?>): Unit {
        setField(GtrgmDistance._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Any?): Unit = setValue(GtrgmDistance._5, value)
    ...
    fun set__5(field: Field<Any?>): Unit {
        setField(GtrgmDistance._5, field)
    }
}
