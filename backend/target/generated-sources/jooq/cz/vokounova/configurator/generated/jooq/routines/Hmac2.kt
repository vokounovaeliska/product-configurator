...
open class Hmac2 : AbstractRoutine<ByteArray>("hmac", Public.PUBLIC, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Hmac2.RETURN_VALUE
        addInParameter(Hmac2._1)
        addInParameter(Hmac2._2)
        addInParameter(Hmac2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Hmac2._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Hmac2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: ByteArray?): Unit = setValue(Hmac2._2, value)
    ...
    fun set__2(field: Field<ByteArray?>): Unit {
        setField(Hmac2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(Hmac2._3, value)
