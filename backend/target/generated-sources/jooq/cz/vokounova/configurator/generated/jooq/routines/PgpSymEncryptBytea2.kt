...
open class PgpSymEncryptBytea2 : AbstractRoutine<ByteArray>("pgp_sym_encrypt_bytea", Public.PUBLIC, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = PgpSymEncryptBytea2.RETURN_VALUE
        addInParameter(PgpSymEncryptBytea2._1)
        addInParameter(PgpSymEncryptBytea2._2)
        addInParameter(PgpSymEncryptBytea2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(PgpSymEncryptBytea2._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(PgpSymEncryptBytea2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(PgpSymEncryptBytea2._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(PgpSymEncryptBytea2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(PgpSymEncryptBytea2._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(PgpSymEncryptBytea2._3, field)
    }
}
