...
open class Unaccent2 : AbstractRoutine<String>("unaccent", Public.PUBLIC, SQLDataType.CLOB) {
    companion object {
    ...
    init {
        returnParameter = Unaccent2.RETURN_VALUE
        addInParameter(Unaccent2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Unaccent2._1, value)
