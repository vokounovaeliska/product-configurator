...
open class UnaccentLexize : AbstractRoutine<Any>("unaccent_lexize", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = UnaccentLexize.RETURN_VALUE
        addInParameter(UnaccentLexize._1)
        addInParameter(UnaccentLexize._2)
        addInParameter(UnaccentLexize._3)
        addInParameter(UnaccentLexize._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(UnaccentLexize._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(UnaccentLexize._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(UnaccentLexize._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(UnaccentLexize._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(UnaccentLexize._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(UnaccentLexize._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Any?): Unit = setValue(UnaccentLexize._4, value)
    ...
    fun set__4(field: Field<Any?>): Unit {
        setField(UnaccentLexize._4, field)
    }
}
