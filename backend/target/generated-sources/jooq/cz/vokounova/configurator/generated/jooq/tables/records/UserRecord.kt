...
open class UserRecord private constructor() : UpdatableRecordImpl<UserRecord>(User.USER) {
     ...
     */
    constructor(id: UUID, email: String, createdAt: OffsetDateTime, modifiedAt: OffsetDateTime, firstName: String, surname: String, password: String, checkSum: String): this() {
        this.id = id
        this.email = email
