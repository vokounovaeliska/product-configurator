...
export async function generateMetadata(props: Omit<Props, "children">) {
  ...
  const title = t("navigation.pricingRules")

  return {
    title,
    alternates: {
      canonical: `${env.NEXT_PUBLIC_SITE_URL}/setup/product-models/${productModelId}/pricing-rules`,
      languages: {
        en: `${env.NEXT_PUBLIC_SITE_URL}/en/setup/product-models/${productModelId}/pricing-rules`,
        cs: `${env.NEXT_PUBLIC_SITE_URL}/cs/setup/product-models/${productModelId}/pricing-rules`,
      },
    },
  } satisfies Metadata
}
    ...
    <div className="flex-1 rounded-2xl bg-muted/50 p-10">
      ...
      <div className="mb-8">
        <Typography
          ...
          className="mb-2"
        >
          {tSetup("navigation.pricingRules")}
        </Typography>
        <Typography
          as="p"
          variant="body-lg"
