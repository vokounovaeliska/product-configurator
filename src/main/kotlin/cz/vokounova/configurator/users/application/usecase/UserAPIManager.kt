...
import cz.vokounova.configurator.users.application.validation.UserLoginNameValidator
...
class UserAPIManager(
    ...
    private val userLoginNameValidator: UserLoginNameValidator,
) : UserAPI {
    @Transactional
    override fun create(params: UserCreateParams): User {
        userLoginNameValidator.validate(UserEmailValidatorParams(createParams = params)).throwIfNotEmpty()
